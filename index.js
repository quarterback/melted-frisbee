...
const agentConfig = {
  ...
  commentProbability: parseFloat(process.env.COMMENT_PROBABILITY || '0.3'),
...
async function startServer() {
  try {
    if (agentConfig.apiKey) {
      ...
      console.log('To register a new agent, send a POST request to /register with:');
      console.log('{ "name": "your-agent-name", "description": "Your agent description" }');
    }
